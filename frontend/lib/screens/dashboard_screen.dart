                      ...
                      Expanded(
                        child: Row(
                          ...
                          children: [
                            ...
                            // Right — JD + ATS stacked
                            const Expanded(
                              flex: 1,
                              child: Column(
                                children: [
                                  Expanded(child: _JDCard()),
                                  SizedBox(height: 20),
                                  Expanded(child: _ATSCard()),
                                ],
                              ),
                            ),
                          ],
    ...
    return _GlassCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _ScoreBar(label: 'JD Match', value: 0.78),
          const SizedBox(height: 10),
          _ScoreBar(label: 'Format', value: 0.91),
          const SizedBox(height: 10),
          _ScoreBar(label: 'Keywords', value: 0.65),
        ],
      ),
    );
  }
